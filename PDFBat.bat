...
IF "%MultiPrint%"=="1" (
	ECHO.
	ECHO You  need to close the Acrobat Reader window manually after the printing
	ECHO is finished.
...
:Syntax
ECHO.
ECHO PrintPDF.bat,  Version 2022
ECHO Prints PDF files from the cmd
ECHO.
